...
Shader "Isida/CanopyGlassTwoSide"
{
	Properties
	{
		_InnerGlassColor("Inner Glass Color", Color) = (0,0,0,0)
		...
		[Toggle(_FRASNELOUTERRIM_ON)] _FrasnelOuterRim("Frasnel Outer Rim", Float) = 0
		[Toggle(_INNERGLASSFRESNELCOLORING_ON)] _InnerGlassFresnelColoring("Inner Glass Fresnel Coloring", Float) = 0
		[Header(Translucency)]
		...
		_OuterTranslicency("Outer Translicency", Range( 0 , 1)) = 0
		...
		_OuterGlassSmoothnes("Outer Glass Smoothnes", Range( 0 , 1)) = 0
		_OuterMetalic("Outer Metalic", Range( 0 , 1)) = 0
		_OuterOpacity("Outer Opacity", Range( 0 , 1)) = 0
		...
		_OuterTexturePower("Outer Texture Power", Float) = 11.16
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _INNERGLASSFRESNELCOLORING_ON
		#pragma shader_feature_local _FRASNELOUTERRIM_ON
		...
		uniform half4 _InnerGlassColor;
		uniform half _OuterMetalic;
		uniform half _InnerMetalic;
		uniform half _OuterGlassSmoothnes;
		...
		uniform half _OuterTranslicency;
		uniform half _InnerRoughnessPowerSunside;
		uniform half _GradientPower;
		uniform half _OuterOpacity;
		uniform half _OuterTexturePower;
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			#ifdef _INNERGLASSFRESNELCOLORING_ON
				half4 staticSwitch272 = FresnelColor253;
			#else
				half4 staticSwitch272 = _InnerGlassColor;
			#endif
			half4 lerpResult244 = lerp( ( FresnelColor253 + temp_output_237_0 ) , ( staticSwitch272 + temp_output_237_0 ) , i.vertexColor);
			o.Albedo = lerpResult244.rgb;
			half lerpResult265 = lerp( _OuterMetalic , _InnerMetalic , i.vertexColor.r);
			o.Metallic = lerpResult265;
			half fresnelNdotV267 = dot( ase_worldNormal, ase_worldViewDir );
			half fresnelNode267 = ( 25.4 + -96.1 * pow( 1.0 - fresnelNdotV267, 8.12 ) );
			half OuterFresnel278 = fresnelNode267;
			half clampResult280 = clamp( ( OuterFresnel278 * _OuterGlassSmoothnes ) , 0.0 , 1.0 );
			#ifdef _FRASNELOUTERRIM_ON
				half staticSwitch281 = clampResult280;
			#else
				half staticSwitch281 = _OuterGlassSmoothnes;
			#endif
			half lerpResult262 = lerp( staticSwitch281 , _InnerGlassSmoothnes , i.vertexColor.r);
			o.Smoothness = lerpResult262;
			half4 temp_output_235_0 = ( ( tex2DNode225 * _InnerRoughnessPowerSunside ) + temp_output_224_0 );
			half dotResult116 = dot( ase_worldNormal , _WorldSpaceLightPos0.xyz );
			half temp_output_199_0 = pow( -dotResult116 , _GradientPower );
			half4 color207 = IsGammaSpace() ? half4(1,1,1,0) : half4(1,1,1,0);
			half4 lerpResult246 = lerp( ( _OuterTranslicency * ( temp_output_235_0 * temp_output_199_0 ) ) , ( ( temp_output_235_0 * color207 ) * temp_output_199_0 ) , i.vertexColor);
			half4 clampResult210 = clamp( lerpResult246 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			...
			half4 lerpResult245 = lerp( ( _OuterOpacity + ( ( temp_output_240_0 + temp_output_224_0 ) * _OuterTexturePower ) ) , ( ( ( temp_output_237_0 * color193 ) + _InnerOpacity ) * pow( ( temp_output_179_0 - _TextureGradientBias ) , _GradientPower ) ) , i.vertexColor);
			half4 clampResult220 = clamp( lerpResult245 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18900
316.8;252.8;1288;800;888.6077;208.8953;1.536644;True;False
Node;AmplifyShaderEditor.RangedFloatNode;257;-526.7799,2391.303;Inherit;False;Property;_FresnelScale;Fresnel Scale;3;0;Create;True;0;0;0;False;0;False;11.56;2.48;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;258;-541.7799,2459.303;Inherit;False;Property;_FresnelPower;Fresnel Power;5;0;Create;True;0;0;0;False;0;False;1.69;1.36;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;256;-527.7799,2315.303;Inherit;False;Property;_FresnelBias;Fresnel Bias;4;0;Create;True;0;0;0;False;0;False;0;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1016.62,-207.8778;Inherit;True;Property;_Texture1;Texture 1;16;0;Create;True;0;0;0;False;0;False;-1;a68789ba50055df42a757c9a30ff944a;9403d6b62fc4d694ebf590d63f5c8ab5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;241;-903.8822,-751.6789;Inherit;False;Property;_InnerOuterRoughnessPower;Inner-Outer Roughness Power;27;0;Create;True;0;0;0;False;0;False;0;0.004;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;225;-984.3615,-651.3462;Inherit;True;Property;_SurficeRougness;Surfice Rougness;25;0;Create;True;0;0;0;False;0;False;-1;None;af5f46dfacb91c749be3c34d42a00dfe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;223;-1008.098,71.95682;Inherit;True;Property;_Texture2;Texture 2;17;0;Create;True;0;0;0;False;0;False;-1;None;a68789ba50055df42a757c9a30ff944a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;250;-492.3755,1677.719;Inherit;False;Property;_FresnelColor1;Fresnel Color 1;2;0;Create;True;0;0;0;False;0;False;0,0.1269569,1,0;0.3560469,0.9716981,0.3254272,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;233;-978.6158,-462.0494;Inherit;False;Property;_InnerRoughnessPowerSunside;Inner Roughness Power Sunside;26;0;Create;True;0;0;0;False;0;False;0;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;252;-488.3187,1869.286;Inherit;False;Property;_FresnelColor2;Fresnel Color 2;1;0;Create;True;0;0;0;False;0;False;0,1,0.07791209,0;0.8690889,0.5330188,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-555.9149,1268.88;Inherit;False;Property;_GradientPower;Gradient Power;34;0;Create;True;0;0;0;False;0;False;1.33;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;193;-614.4984,440.6063;Inherit;False;Constant;_Transperency;Transperency;22;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;162;-417.9318,976.3575;Inherit;False;Property;_TextureGradientBias;Texture Gradient Bias;33;0;Create;True;0;0;0;False;0;False;0.4;-7.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-371.5318,611.7182;Inherit;False;Property;_InnerOpacity;Inner Opacity;20;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;207;-171.7977,85.83364;Inherit;False;Constant;_TranscluencyColor;Transcluency Color;30;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;199;-312.7984,1375.088;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;270;117.5557,41.36102;Inherit;False;Property;_OuterTexturePower;Outer Texture Power;29;0;Create;True;0;0;0;False;0;False;11.16;11.16;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;1002.71,-363.7641;Inherit;False;Property;_OuterGlassSmoothnes;Outer Glass Smoothnes;21;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;269;332.6946,-45.58432;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;190;33.2732,1252.701;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;285;54.80241,381.5237;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;254;-216.6233,-618.5861;Inherit;False;253;FresnelColor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;100;-352.2306,-888.6755;Inherit;False;Property;_InnerGlassColor;Inner Glass Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;247;970.1041,-133.6941;Inherit;False;Property;_OuterOpacity;Outer Opacity;23;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;283;51.85871,120.145;Inherit;False;Property;_OuterTranslicency;Outer Translicency;15;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;284;343.9608,111.4517;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;209;244.0998,330.459;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;243;174.3565,-349.3384;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;272;-23.09274,-838.0705;Inherit;False;Property;_InnerGlassFresnelColoring;Inner Glass Fresnel Coloring;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;221;204.9738,560.5602;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;274;1208.334,10.8236;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;44;991.1667,-290.3644;Inherit;False;Property;_InnerMetalic;Inner Metalic;19;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;245;561.4063,-158.5981;Inherit;False;3;0;COLOR;1,1,1,0;False;1;COLOR;1,1,1,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;266;988.204,-213.6975;Inherit;False;Property;_OuterMetalic;Outer Metalic;22;0;Create;True;0;0;0;False;0;False;0;0.105;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;1017.609,-440.1166;Inherit;False;Property;_InnerGlassSmoothnes;Inner Glass Smoothnes;18;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;246;537.8851,43.61802;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-819.2166,2224.993;Inherit;False;Property;_FresnelGradientMultiplayer;Fresnel Gradient Multiplayer;30;0;Create;True;0;0;0;False;0;False;1.65;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;210;684.959,339.975;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;126;-936.1989,871.2938;Inherit;False;Property;_Float1;Float 1;28;0;Create;True;0;0;0;False;0;False;1.69;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-547.8287,2224.97;Inherit;False;Property;_FresnelGradientSubstract;Fresnel Gradient Substract;32;0;Create;True;0;0;0;False;0;False;0.71;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1898.267,2682.921;Inherit;False;Property;_Float2;Float 2;31;0;Create;True;0;0;0;False;0;False;18.75;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;909.5775,291.0664;Half;False;True;-1;2;;0;0;Standard;Isida/CanopyGlassTwoSide;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;3;1;False;-1;10;False;-1;0;4;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;24;8;35;-1;0;True;0;0;False;-1;-1;0;False;-1;0;0;0;False;0;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;285;0;235;0
WireConnection;285;1;199;0
...
ASEEND*/
//CHKSM=3334F754783E2EC3B6EDDF743D3EC7E3CCD42835